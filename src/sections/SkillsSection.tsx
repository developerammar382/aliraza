...
import { Code, Database, Globe, Server, FileCode, Cpu, MessageSquare, Users, Wrench, Briefcase, Sparkles, Repeat } from 'lucide-react';
...
const SkillsSection: React.FC = () => {
  ...
  const technicalSkills = [
    ...
    { icon: <Server />, title: 'Backend Development', level: 95 },
    { icon: <Globe />, title: 'Responsive Design', level: 100 },
    { icon: <FileCode />, title: 'React/Next.js', level: 85 },
    { icon: <Database />, title: 'MySql | PostgreSql', level: 89 },
    { icon: <Cpu />, title: 'UI/UX Implementation', level: 100 }
  ];
  ...
  const professionalSkills = [
    ...
    { icon: <Repeat />, title: 'Adaptability', description: 'Ability to quickly learn new tools, frameworks, and adjust to changing project requirements' }
  ];
      ...
      <div className="container max-w-6xl px-4 md:px-6">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-4 md:gap-6">
            {[
              'HTML', 'CSS', 'JavaScript', 'JQuery', 'AJAX', 'React', 'Tailwind CSS', 'Bootstrap',
              'PHP', 'Laravel', 'MySQL', 'PostgreSql', 'npm', 'Vite', 'Webpack',
              'VS Code', 'Sublime Text', 'PhpStorm', 'Postman', 'Git', 'GitHub', 'GitLab', 'Bitbucket',
              'Postman', 'Vercel', 'Netlify', 'Figma'
            ].map((tech, index) => (
              <motion.div
                key={index}
